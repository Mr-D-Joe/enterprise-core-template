...
check_contains "$BASE_DIR/DESIGN.md" "## Derived execution context" "DESIGN derived-execution section present"
...
check_contains "$BASE_DIR/DESIGN.md" "## Source inclusion rules" "DESIGN source-inclusion section present"
...
check_contains "$BASE_DIR/changes/CHG-TEMPLATE.md" "## Backlog extraction" "Change-brief template backlog extraction section present"
check_contains "$BASE_DIR/changes/CHG-TEMPLATE.md" "## Changelog extraction" "Change-brief template changelog extraction section present"
check_contains "$BASE_DIR/changes/CHG-TEMPLATE.md" "## Lastenheft inclusion decision" "Change-brief template lastenheft section present"
check_contains "$BASE_DIR/changes/CHG-TEMPLATE.md" "## ADR inclusion decision" "Change-brief template ADR section present"
